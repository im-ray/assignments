...
from app.database.postgres_helper import clean_dataframe, rename_columns_to_snake_case, write_dataframe_to_postgres
...
def upload_csv_with_url(app):
    ...
    def upload_csv_from_url():
        ...
        try:
            ...
            # Step 3: Rename columns to match the PostgreSQL schema
            df_snake_case = rename_columns_to_snake_case(df_cleaned)
            # Step 4: Write the cleaned DataFrame to PostgreSQL
            write_dataframe_to_postgres(df_snake_case, table_name='game_data')
